...
{loading?(
  ...
  courses.map((e) => (
    <div className={styles.box}>
      ...
      <h5 style={{margin:"0"}}><label style={{color:"#4035b8"}}>Subject:</label> {e.subject}</h5>
      <p style={{margin:"0"}}><label style={{color:"#4035b8"}}>For:</label> {e.class}</p>
      <p style={{margin:"0"}}><label style={{color:"#4035b8"}}>Teacher:</label> {e.Teacher}</p>
      
      <p style={{margin:"0"}}><label style={{color:"#4035b8"}}>Description:</label> {e.description}</p>
      <p style={{margin:"2px"}}><label style={{color:"#4035b8"}}>Starts On:</label>{e.start}</p>
      <p style={{margin:"2px"}}><label style={{color:"#4035b8"}}>Course Fee:</label> Rs. {e.Fee} <button className="button" onClick={()=>{alert("Course will be added to Your Profile Shortly")}}>Buy Course</button></p>
